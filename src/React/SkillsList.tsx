...
const SkillsList = () => {
  ...
  const skills = {
    "Developpeur Web": [
      "Applications web modernes (SPAs) avec React, Vue.js et Astro",
      "Sites vitrine et e-commerce performants et optimisés SEO",
      "Portfolios interactifs et sites personnalisés responsive",
    ...
    "Developpeur Mobile": [
      ...
      "Interfaces mobiles adaptatives et fluides",
      "Intégration de fonctionnalités natives (caméra, géolocalisation, notifications)",
    ],
    "UI/UX Design & Prototype": [
      "Conception d'interfaces utilisateur modernes avec Figma & Canva",
      "Recherche UX et tests d'utilisabilité pour améliorer l'expérience",
      "Prototypage interactif pour sites web et applications mobiles",
      "Design systems et guides de style cohérents",
      "Wireframing et maquettes haute-fidélité",
    ],
  };
  ...
  return (
    <div className="text-left pt-3 md:pt-9">
      <h3 className="text-[var(--white)] text-1xl md:text-2xl font-semibold md:mb-6">
